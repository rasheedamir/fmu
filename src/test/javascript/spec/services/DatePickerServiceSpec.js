...
describe('TableService Tests ', function() {
    ...
    it('should calculate correct date range with null values in data set', function() {
        scope.tableData = [{
            'creationTime': null
        }, {
            'creationTime': date2
        ...
        expect(scope.startDate).toBe(date2);
    ...
    it('should be able to convert date milis of value null to human readable date string', function() {
        var formattedDate = dateService.getFormattedDate(null);
