...
angular.module('fmuClientApp')
    .factory('OrderService', ['$q', '$http', 'RESTURL',
        function($q, $http) { //, RESTURL) {
            return {
                getEavrops: function() {
                    return $http.get('/app/rest/eavrop/fromdate/631148400000/todate/32188143600000' +
                        '/status/NOT_ACCEPTED/page/0/pagesize/10/sortkey/arendeId/sortorder/ASC').then(function(data) {
                        // Success
                        return data.data;
                    }, function(err) {
